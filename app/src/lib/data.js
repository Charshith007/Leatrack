...
export const STATUSES = ["Imported", "Not contacted", "Contacted", "Customer", "Closed"];

// Pipeline stages — the core of LEA Track
export const STAGES = ["contact", "enrich", "convert"];

export const SOURCES = ["Web form", "Open house", "Referral", "Social media", "Zillow", "Cold list"];
...
export function makeContact(stage, i) {
...
export const STAGE_LABEL = { contact: "Contact", enrich: "Enrich", convert: "Convert" };

export const LeaData = { PROPERTIES, STATUSES, STAGES, SOURCES, load, save, reset, uid, makeContact, STAGE_LABEL };
